...
const quiz = [
  {
    ...
    correctIndex: 1,
    explanation:
      "« Il est 7 heures du matin » correspond à 7 AM, pas 7 PM. La phrase en anglais est donc fausse."
  },
  {
    audio: "audio/q2.mp3",
    choices: ["True", "False"],
    correctIndex: 0,
    explanation:
      "« Il est 3 heures de l’après-midi » correspond bien à 3 PM. La phrase en anglais est vraie."
  },
  {
    audio: "audio/q3.mp3",
    choices: ["True", "False"],
    correctIndex: 0,
    explanation:
      "« Mon rendez-vous est lundi » se traduit correctement par “My appointment is on Monday.”"
  },
  {
    audio: "audio/q4.mp3",
    choices: ["True", "False"],
    correctIndex: 1,
    explanation:
      "« Mon rendez-vous est vendredi » ne correspond pas à Tuesday. La phrase en anglais est fausse."
  },
  {
    audio: "audio/q5.mp3",
    choices: ["True", "False"],
    correctIndex: 0,
    explanation:
      "« Je suis né en 1998 » correspond exactement à “I was born in 1998.”"
  },
  {
    audio: "audio/q6.mp3",
    choices: ["True", "False"],
    correctIndex: 1,
    explanation:
      "« Je suis né en 2005 » ne correspond pas à 1995. La phrase en anglais est fausse."
  },
  {
    audio: "audio/q7.mp3",
    choices: ["True", "False"],
    correctIndex: 0,
    explanation:
      "« Nous sommes en été » se traduit correctement par “It is summer.”"
  },
  {
    audio: "audio/q8.mp3",
    choices: ["True", "False"],
    correctIndex: 1,
    explanation:
      "« Nous sommes en hiver » ne correspond pas à spring. La phrase en anglais est fausse."
  },
  {
    audio: "audio/q9.mp3",
    choices: ["True", "False"],
    correctIndex: 0,
    explanation:
      "« Mon anniversaire est en mars » correspond bien à “My birthday is in March.”"
  },
  {
    audio: "audio/q10.mp3",
    choices: ["True", "False"],
    correctIndex: 1,
    explanation:
      "« Mon rendez-vous est à 9 heures du soir » correspond à 9 PM, pas 9 AM. La phrase en anglais est fausse."
  }
];
```
